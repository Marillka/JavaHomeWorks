...
public class GameMap extends JPanel {
    ...
    // ФИШКИ
    private static final int DOT_HUMAN = 1; // фишки человека и компа объявлены интами, чтобы переиспользовать логику из старых крестиков ноликов, мы будем гонять тоже на поле (чары нам не нужны, потому что мы их отображать не будем, а будем рисовать)
